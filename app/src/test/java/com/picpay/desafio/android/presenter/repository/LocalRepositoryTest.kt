...
class LocalRepositoryTest {
    ...
    fun getAll() {
        ...
        val data = listOf<UsersLocal>(
            ...
            UsersLocal(2,"Carli Carroll", "Tod86","https://randomuser.me/api/portraits/men/2.jpg"),
            UsersLocal(3,"Annabelle Reilly", "Tod86","https://randomuser.me/api/portraits/men/3.jpg"),
            UsersLocal(4,"Mrs. Hilton Welch", "Tod86","https://randomuser.me/api/portraits/men/4.jpg"),)
